...
const ptTranslationsBase = {
  ...
  "tableMaps": {
    ...
    "bulkCreateTables": "Criar Múltiplas Mesas",
    "bulkCreateDescription": "Crie várias mesas automaticamente com nomes sequenciais",
    "createTablesOnMapCreation": "Criar mesas automaticamente ao criar o mapa",
    "tablePrefix": "Prefixo da Mesa",
    "tablePrefixPlaceholder": "Ex: salon, D, terraço (opcional)",
    "tableCount": "Quantidade de mesas",
    "tableCapacity": "Capacidade por mesa",
    "creating": "Criando...",
    "createTables": "Criar {{count}} mesas",
    "bulkCreateSuccess": "Criadas {{count}} mesas com sucesso",
    "bulkCreateError": "Erro ao criar as mesas",
    "bulkCreateHint": "Use o botão 'Criar Múltiplas Mesas' para adicionar mesas a este mapa",
    "delete": {
  ...
  "tables": {
    ...
    "tableMaps": {
      ...
      "tablePrefix": "Prefixo da Mesa",
      "tablePrefixPlaceholder": "Digite o prefixo da mesa",
      "tableCount": "Contagem de Mesas",
      "delete": {
        "confirmTitle": "Excluir Mapa de Mesa",
        "confirmDescription": "Tem certeza de que deseja excluir o mapa de mesa '{{name}}'?",
        "success": "Mapa de mesa excluído",
  ...
  "settings": {
    ...
    "mobileApp": {
      "title": "App Móvel PDV",
      "description": "Baixe o aplicativo móvel de ponto de venda para dispositivos Android",
      "appName": "Comandero POS Móvel",
      "appDescription": "Aplicativo Android para gerenciamento de ponto de venda",
      "platform": "Aplicativo Android",
      "version": "Versão 1.0",
      "downloadButton": "Baixar APK",
      "fileInfo": "Tamanho: ~50 MB • Requer Android 5.0 ou superior",
      "features": {
        "pos": {
          "title": "Funcionalidade completa de PDV",
          "description": "Faça pedidos, gerencie mesas e processe pagamentos"
        },
        "offline": {
          "title": "Modo offline",
          "description": "Continue trabalhando sem conexão com a internet"
        },
        "sync": {
          "title": "Sincronização em tempo real",
          "description": "Os dados são sincronizados automaticamente quando conectado"
        },
        "printer": {
          "title": "Integração com impressoras",
          "description": "Conecte impressoras Bluetooth"
        }
      },
      "installation": {
        "title": "Instruções de instalação",
        "step1": "Baixe o arquivo APK usando o botão acima",
        "step2": "No seu dispositivo Android, vá em Configurações → Segurança",
        "step3": "Habilite \"Instalar de fontes desconhecidas\"",
        "step4": "Abra o arquivo APK baixado para instalar",
        "step5": "Após a instalação, você pode desabilitar \"Instalar de fontes desconhecidas\""
      }
    }
  },
  ...
  "printers": {
    "title": "Impressoras",
    "description": "Configure impressoras térmicas para imprimir comandas",
    "addPrinter": "Adicionar Impressora",
    "add": "Adicionar",
    "addPrinterDescription": "Selecione e conecte uma impressora térmica",
    "printerName": "Nome da impressora",
    "printerNamePlaceholder": "Ex: Impressora Caixa 1",
    ...
    "disableAutoPrint": "Desabilitar auto",
    "connecting": "Conectando...",
    "noPrinters": "Nenhuma impressora configurada",
    "bluetoothNotSupported": "Seu navegador não suporta Bluetooth. Por favor use um navegador compatível como Chrome ou Edge.",
    "usbNotSupported": "Seu navegador não suporta USB. Por favor use um navegador compatível como Chrome ou Edge.",
    "networkPrinterInfo": "Para impressoras de rede, digite o endereço IP e porta da impressora.",
    "manualConfigInfo": "Configuração manual: A impressora será salva mas não conectada automaticamente."
  },
