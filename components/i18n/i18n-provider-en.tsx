...
const enTranslationsBase = {
  ...
  "tableMaps": {
    ...
    "bulkCreateTables": "Create Multiple Tables",
    "bulkCreateDescription": "Create multiple tables automatically with sequential names",
    "createTablesOnMapCreation": "Create tables automatically when creating the map",
    "tablePrefix": "Table Prefix",
    "tablePrefixPlaceholder": "Eg: salon, D, terrace (optional)",
    "tableCount": "Number of tables",
    "tableCapacity": "Capacity per table",
    "creating": "Creating...",
    "createTables": "Create {{count}} tables",
    "bulkCreateSuccess": "Successfully created {{count}} tables",
    "bulkCreateError": "Error creating tables",
    "bulkCreateHint": "Use the 'Create Multiple Tables' button to add tables to this map",
    "delete": {
  ...
  "tables": {
    ...
    "tableMaps": {
      ...
      "tablePrefix": "Table Prefix",
      "tablePrefixPlaceholder": "Enter table prefix",
  ...
  "dashboard": {
    ...
    "trial": {
      ...
      "message": "You have {{daysLeft}} days left in your trial. Your plan: {{plan}}"
    },
  ...
  "orders": {
    ...
    "paymentMethodDescription": "Choose the payment method for this order",
    "paymentMethods": {
      "cash": "Cash",
      "credit": "Credit Card",
      "debit": "Debit Card",
  ...
  "inventory": {
    ...
    "manageCategoriesDesc": "Create, edit or delete categories to organize your inventory.",
    ...
    "categoryNamePlaceholder": "Ex. Drinks, Meats",
    ...
    "fetchError": "Error fetching inventory",
    "fillRequiredFieldsMsg": "Please complete the required fields",
    "categoryAlreadyExists": "Category already exists",
    "saveSuccess": "Saved successfully",
    "saveError": "Error saving",
    "deleteSuccess": "Deleted successfully",
    "deleteError": "Error deleting",
    "categoryNotEmpty": "Cannot delete category because it contains items.",
    "noCategoryError": "No category selected",
    ...
    "errorSavingItemMsg": "Error saving item",
    "errorNoItemSelectedToAddStock": "No item selected to add stock",
    "errorQuantityToAddPositive": "Quantity to add must be positive",
    "stockAddedSuccessfullyMsg": "Stock added successfully",
    "errorAddingStockMsg": "Error adding stock",
    "editBtn": "Edit",
    "addStockBtn": "Add Stock",
    "addStockTo": "Add stock to",
    "currentQuantity": "Current quantity",
    "quantityToAddLabel": "Quantity to add",
    "enterQuantityPlaceholder": "Enter quantity",
    "addStockConfirmBtn": "Add Stock",
  ...
  "setup": {
    "title": "Create Your Establishment",
    "description": "Welcome! Let's set up your restaurant establishment",
    "establishmentNameLabel": "Establishment Name",
    "establishmentNamePlaceholder": "Enter your restaurant name",
  ...
  "register": {
    ...
    "trialInfo": "Start with a 14-day free trial on any plan",
    "submit": "Register",
  ...
  "settings": {
    ...
    "establishment": {
      ...
      "actions": {
        ...
        "save": "Save Changes",
        "saving": "Saving...",
        "saved": "Establishment information saved successfully",
        "error": "Error saving establishment information",
    ...
    "security": {
      ...
      "twoFactorInfo": "Require a code when logging in from a new device",
      "twoFactorComingSoon": "Two-Factor Authentication coming soon",
      "loginHistory": "Login History",
      "loginHistoryComingSoon": "Login history feature coming soon",
    ...
    "sessionHistory": {
      ...
      "description": "View login/logout history and work hours for team members",
      "noPermission": "You don't have permission to view session history",
      "filters": "Filters",
