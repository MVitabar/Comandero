...
const esTranslationsBase = {
  ...
  "tableMaps": {
    ...
    "bulkCreateTables": "Crear múltiples mesas",
    "bulkCreateDescription": "Crea varias mesas automáticamente con nombres secuenciales",
    "createTablesOnMapCreation": "Crear mesas automáticamente al crear el mapa",
    "tablePrefix": "Prefijo de mesa",
    "tablePrefixPlaceholder": "Ej: salon, D, terraza (opcional)",
    "tableCount": "Cantidad de mesas",
    "tableCapacity": "Capacidad por mesa",
    "creating": "Creando...",
    "createTables": "Crear {{count}} mesas",
    "bulkCreateSuccess": "Se crearon {{count}} mesas exitosamente",
    "bulkCreateError": "Error al crear las mesas",
    "bulkCreateHint": "Usa el botón 'Crear múltiples mesas' para agregar mesas a este mapa",
    "delete": {
  ...
  "tables": {
    ...
    "tableMaps": {
      ...
      "tablePrefix": "Prefijo de la mesa",
      "tablePrefixPlaceholder": "Introduce el prefijo de la mesa",
      "tableCount": "Cantidad de mesas",
      "delete": {
        "confirmTitle": "Eliminar mapa",
        "confirmDescription": "¿Estás seguro de que quieres eliminar el mapa '{{name}}'?",
